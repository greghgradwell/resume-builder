...
**Step 1: Delete any existing .generate.yaml for Audi job (to test first-run prompt)**

```bash
rm -f jobs/audi/adas-ad-software-engineer/.generate.yaml
```

**Step 2: Run generate.py interactively**

```bash
source ~/.venvs/resume-builder/bin/activate && python scripts/generate.py --data jobs/audi/adas-ad-software-engineer/tailored.yaml --keep-html
```
...
```bash
pdfinfo jobs/audi/adas-ad-software-engineer/resume.pdf
```
...
```bash
source ~/.venvs/resume-builder/bin/activate && python scripts/generate.py --data jobs/audi/adas-ad-software-engineer/tailored.yaml
```
...
```bash
git add INSTRUCTIONS.md CLAUDE.md jobs/audi/adas-ad-software-engineer/.generate.yaml

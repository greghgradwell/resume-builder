...
Select template [1]: _
Output path [jobs/example/software-engineer/resume.pdf]: _

Saving settings to jobs/example/software-engineer/.generate.yaml
```
...
Using saved settings (.generate.yaml):
  template: modern
  output:   jobs/example/software-engineer/resume.pdf
```
